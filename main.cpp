...
void Display(Mylist<T>& list, int& operationNum, int& displayOperationNum)
{
	...
	case 1:
		...
		{
			std::cout << "—v‘f‚ª‘¶İ‚µ‚Ü‚¹‚ñ" << std::endl;
		}
	...
	case 2:
		...
		if (list.Size() != 0)
		{
			...
			{
				std::cout << specifyNum << "”Ô–Ú‚Ì—v‘f‚ªŒ©‚Â‚©‚è‚Ü‚¹‚ñ‚Å‚µ‚½B" << std::endl;
			}
...
void Insert(Mylist<T>& list, int& operationNum)
{
	...
	else
	{
		...
		{
			std::cout << index << "”Ô–Ú‚Ì—v‘f‚ªŒ©‚Â‚©‚è‚Ü‚¹‚ñ‚Å‚µ‚½B" << std::endl;
		}
...
void Edit(Mylist<T>& list, int& operationNum)
{
	...
	{
		std::cout << elementNum << "”Ô–Ú‚Ì—v‘f‚ªŒ©‚Â‚©‚è‚Ü‚¹‚ñ‚Å‚µ‚½B" << std::endl;
	}
